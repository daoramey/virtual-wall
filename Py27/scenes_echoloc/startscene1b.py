...
trackingDataFile.write(str('++++ scene1_echoloc_1wall_separat +++++++++++  ') + str(now.isoformat()) + str('\n'))
...
time.sleep(1)
startBinSimcommand=('start cmd.exe /c python %homepath%/Desktop/pyBinSim_version061216/TranslationWithVive2pyBinSim_25cm_1Wall_Sep.py')
os.system(startBinSimcommand)

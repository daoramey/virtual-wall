...
trackingDataFile.write(str('++++ Tracking EchoRoom_sep started +++++++++++  ') + str(now.isoformat()) + str('\n'))
...
try:
	while 1:
		...
		Filterset = FiltersetIdx*25+30	# 25cm resolution
		...
		print(' Yaw: ', yaw, ' Filterset: ', Filterset, ' angleOffset ', angleOffset)
		now = datetime.datetime.now()
